...
app.get('/inprocess', async (req, res) => {
    try {
...
app.get('/admin_inprocess',async (req,res)=>{
    try {
        const data = await complaint.find({});;
...
app.get('/admin_resolve',async (req,res)=>{
    try {
        const data = await resolve.find({});
...
app.get('/admin_mess_menu',async (req,res)=>{
    if(req.session.user.hostel==="Patel Hostel"){
        try {
            const data = await patelmenu.find({});
